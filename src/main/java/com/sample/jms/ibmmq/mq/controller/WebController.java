...
public class WebController {
    ...
    @ResponseBody
    public String produce(@RequestParam("msg") String msg, @RequestParam("correlationID") String correlationID, @RequestParam("messageID") String messageID, @RequestParam("qName") String qName, @RequestParam("replyQueue") String replyQueue) {
        jmsClient.send(msg, correlationID, messageID, qName, replyQueue);
